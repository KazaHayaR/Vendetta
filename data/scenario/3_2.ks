...
#【ユラギ】
「何をッ……しゃべるんじゃないッ……その炎はすぐに消さないと……ッ！」[lrcm]
...
ユラギは、おつきがさらわれた時こう言った。「また、いなくなってしまった」と。[lrcm]
...
#【一】
「……君は神様だけど、俺達の友達なんだろう？　なら……俺たちは対等だ。守りたいからお互いを守る。そこに、神様も人間もないはずだ」[lrcm]
「ユラギの親友だって、きっと、そう思ってたんじゃないか？」[lrcm]
#【ユラギ】
「……っ！」[lrcm]
#【一】
「だからさ、ユラギ。一人で行こうとしないでくれよ。あの獣に立ち向かうんだったら、俺も手伝う……さほど役には立たなかもしれないけど……まあこの通り、盾ぐらいにはなるから、さ」[lrcm]
#【ユラギ】
...
#
いつの間にか胸の中にいたユラギの涙は止まり、こちらを[lrcm]
...
「……そうか」[lrcm]
#【ユラギ】
「でもっ……私は神様だっ……なのにあの子達に何もしてあげることはできなかったんだ！　大切な……大切な友達だったのに……！」[lrcm]
#【一】
「……うん」[lrcm]
#
...
#【ユラギ】
「……まったく、水祓なんて応急処置程度にしかならないんだぞ……大丈夫だ、私に全部任せて。ハジメは、私に従うだけでいい……」[lrcm]
...
#【ユラギ】
「……君は、幽霊や怪物が怖かったはずなのに……私を庇ってくれるなんて……それなのに私は何もできなくて……神様失格だな」[lrcm]
...
#【ユラギ】
「私の思いも伝えられた。ふふ、好きの感情が辛いという感情をドカーンとぶち破り、溢れてしまった！　つまり、私は愛の力でネガティブを脱することができた！　イェイ！」[lrcm]
...
#【ユラギ】
「……もう、流されて告白でも私はいいんだぞ。まあでも……その誠実さも、ハジメの魅力ではあるが」[lrcm]
...
#【ユラギ】
「これぐらいがちょうどいいのは遺伝子レベルで知ってる！　そしてハジメは私のような容姿の女の子がタイプだからな、籠絡までは長くないだろう！」[lrcm]
#【一】
「う、うるさいなっ！」[lrcm]
#【ユラギ】
...
#【ユラギ】
「だはは……それはそのとおり！」[lrcm]
「でも、一度うちに戻るぞ。あそこじゃないと祠の位置は探知できない。それと、その前に、あの子と、彩と九郎そしてユキ。私の大親友達の話をしよう」[lrcm]
