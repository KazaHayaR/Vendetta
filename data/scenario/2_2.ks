...
[fadeinbgm storage="作戦会議.ogg" time="1000" loop="true"]

[chara_show name="yuragi" top="50" face="def" time="0" top="150"]
#【一】
「はっ、そうじゃなくてだな……！　事件だって！」[lrcm]
[manpu layer=0 name=yuragi type=pikon x="50" y="55" width="80"]
#【ユラギ】
「……おおっ！　そうだったそうだった！」[lrcm]
#【ユラギ】
「よーっし、ひとまず状況整理だ」[lrcm]
...
#
ユラギはゴロンとしていた態勢から座座り直すと、すすっとこちらに寄ってきた。[lrcm]
というかいつの間にか服装が私服に変わっていた。[lrcm]
ふむ、これもなかなか似合っている。[lrcm]
...
#【ユラギ】
「こらっ、神社の息子がそれを疑っちゃ駄目だろー！」[lrcm]
「ホントだっ！　私はこの森に楔を打ってるから、この島の全住人の状況を知覚できるんだぞーっ」[lrcm]
...
#【ユラギ】
「うーむ！　まあ知覚できると行っても、調べようと思わないと調べられないんだけどな！」[lrcm]
[chara_mod name="yuragi" face="emi_m" time="0"]
「ひとまずさらわれた人間については生きていることは確認できた。だけどまぁー油断はできない」[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
「まだ生きているが、いつ殺されるかわからない、という状況でもある」[lrcm]
...
#
ユラギの存在。[lrcm]
それは他の神々の存在を示唆するものでもある。[lrcm]
それはかつてこの世界を作り上げ、人に技術を教え、絶対的な力を持った神々が存在しているということ。[lrcm]
その〝神〟と呼ばれる存在の干渉に対し、”知覚させない”という対抗手段を持っている、ということが一体どういうことなのか。[lrcm]

[manpu layer=0 name=yuragi type=mojamoja x="80" y="80" width="80"]
#【ユラギ】
「うん、攫ったやつは神格か、それに近い妖物のたぐいだろうなぁ……」[lrcm]
...
[manpu layer=0 name=yuragi type=waiwai x="150" y="70" width="80"]
#【ユラギ】
「なっはっは！　[chara_mod name="yuragi" face="emi_m" time="0"]あ、だが知覚不可能な領域にいるとはいっても、住民との縁が完全に切れたわけじゃないぞ」[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
「だから、死んでいるか生きているか、というのは何となく分かる。だからそこは安心してほしい」[lrcm]
...
[chara_mod name="yuragi" face="emi_m" time="0"]
#【ユラギ】
「正確には、ほとんどの神は特定の条件がないとこの世界に干渉自体ができないんだ」[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
「例えば自然の環境が過剰に変わりすぎた時、調律する役目を持った神様とかはそういう干渉ができる」[lrcm]
「例えば守り神や、産土神なんかは庇護対象が妖物なんかに襲われている時、人間を護る為に力を振える」[lrcm]
「そういったように、原則として神は結構厳しい縛りを解除しないとまともに力を使えないんだ」[lrcm]
[chara_mod name="yuragi" face="emi_m" time="0"]
[manpu layer=0 name=yuragi type=oya x="50" y="100" width="80"]
...
[chara_mod name="yuragi" face="def" time="0"]
#【ユラギ】
「まあ今回は〝歪み〟っていうレアケースだ」[lrcm]
「人類史が脅かされるとかじゃないので、天や国の神群は動けないが、[r]
この島を依り代とし、事実上の産土神になっている私なら心おきなく動ける」[lrcm]
...
#【ユラギ】
「だから、こうやって心置きなくハジメと話せるわけだぁ～」[lrcm]
...
#
なんというか大したことじゃないのに褒めてくれると無性にむず痒い。[lrcm]

#【ユラギ】
[chara_mod name="yuragi" face="def" time="0"]
「そう、そいつが人を誘拐した理由。怪異の類が人をさらうような理由としては、そいつをどこか別の場所に連れ去るため、」[lrcm]
「もしくは、何かの儀式を執り行うためにの贄として……ん～」[lrcm]

[manpu layer=0 name=yuragi type=mojamoja x="80" y="80" width="80"]
[chara_mod name="yuragi" face="fukigen" time="0"]
#
ぐぐ～っとユラギは立ち上がると。[lrcm]
...
[chara_mod name="yuragi" face="emi_m" time="0"]
#【ユラギ】
「……ふふ、ハジメはどうやら、大昔の〝祓い〟を身につけてるみたいだな？」[lrcm]
[manpu layer=0 name=yuragi type=onpu x="40" y="90" width="80"]
[chara_mod name="yuragi" face="emi" time="0"]
...
#
少し体の柔らかな場所に触れられた気がして、背が冷える。[lrcm]
[mask effect="fadeIn"]
...
[chara_mod name="yuragi" face="fukigen" time="0"]
#【ユラギ】
「あ、だがもし危険だと思ったらここに逃げてくるんだぞ！」[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
「この島で悪さをしている何かどころか、私が許可しないあらゆる存在が入ってこれない」[lrcm]
[chara_mod name="yuragi" face="emi_m" time="0"]
[manpu layer=0 name=yuragi type=kiran x="50" y="60" width="80"]
「それに私がいれば万事解決だ！」[lrcm]
#【一】
...
[manpu layer=0 name=yuragi type=onpu x="20" y="80" width="80"]
#【ユラギ】
「んふふー、たのもしいなぁ、ハジメ！」[lrcm]
#
[chara_mod name="yuragi" face="emi" time="0"]
そう言ってよしよーしと、こちらの頭をなでてくる。[lrcm]

子供扱いしないでほしいのだが、悪い気はしない。[lrcm]
……そもそもユラギの年齢的に見れば自分は子供どころではないわけだしな。[lrcm]
