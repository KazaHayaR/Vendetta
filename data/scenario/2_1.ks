...
ユラギが言葉を放った瞬間、体中になにかが触れたような感覚が走る。[lrcm]
...
#
驚愕するこちらとは対象的に、のんきな声を上げるユラギ。[lrcm]
#【一】
「楔……？　御神体とは違うのか？」[lrcm]
#
通常この国の神様は御神体と呼ばれるものを依り代として崇拝される。[lrcm]
神社の中によく祀られているものだが、基本的には森や山などの自然物であることが多い。[lrcm]
神社にあるものはそこから『分霊』という儀式を行い依り代を分割し持ってきたものである。[lrcm]
...
そこは、ずっしりとした大樹の上、その枝分かれの間に埋め込まれるように建てられたコテージだった。[lrcm]
おとぎ話に出てきそうな魔女の家と言うには優しげであり、妖精の家というような雰囲気がぴったりだろうか。[lrcm]
...
#【ユラギ】
「んー？　[chara_mod name="yuragi" face="Sodoroki" time="0"]はっ！　あ、あれは……そ、そう！　お、おそなえものだっ！」[lrcm]
#
[chara_mod name="yuragi" face="Smu" time="0"]
どこか慌てた様子で、無い胸をふんす！とはるユラギ。[lrcm]
着崩しすぎている制服のシャツがちらりと舞い上がり、なだらかな曲線が見えた。[lrcm]
...
[chara_mod name="yuragi" face="Semi_m" time="0"]
#【ユラギ】
「まあニギニギ自身が強気受けの上にアレなので、それで興奮している節が在る。だからあんまり効いてないんだけどな〜」[lrcm]
「流石照ちゃんの孫。タフだよね〜」[lrcm]
#【一】
...
[chara_mod name="yuragi" face="Semi_m" time="0"]
#【ユラギ】
「んー、私が見えるだけじゃなくて、触れられるんだなぁって。いやぁー人間に触れられるなんて久しぶりだなぁ……」[lrcm]

#
そういうとユラギは頬だけでなく頭や耳、肩や腕などをペタペタと触り始めた。[lrcm]
柔らかな手のひらの感覚がどこかこそばゆい。[lrcm]
そして、触れるたびにおぉーという、嬉しそうな声を上げる。[lrcm]

#【一】
（……そうか）[lrcm]
#
昔は今よりも神様との距離が近かったという。[lrcm]
...
#
ユラギは驚いたように目を見開く。[lrcm]
が、頬に感じる感触に気づくと、それに委ねるように顔を綻ばせる。[lrcm]

[chara_mod name="yuragi" face="Sterewara" time="0"]
#【ユラギ】
「へへ……なんだよぉー」[lrcm]
...
くっ……不覚にもかわいい……。[lrcm]
[chara_mod name="yuragi" face="Semi" time="0"]
手の感触を確かめるように、ゆらゆらと少しずつ揺れて頬ずりしてくる。[lrcm]
