...
[chara_mod name="yuragi" face="def" time="0"]
#【ユラギ】
「私偏在できないからなぁ……ずっとこの島を見れていなかったりするんだ」[lrcm]
「忙しい時は夏と冬の神版コミケで木花ちゃんのファンネルになるとかで変わってもらってる」[lrcm]
#【一】
「この島の守護体制って……」[lrcm]
#
...
[chara_show name="yuragi" top="50" face="def" time="0" top="150"]
#【ユラギ】
「……わかったろ、ハジメ。この島で最も安全なのは……私の近くではなく、おつきの周囲なのさ」[lrcm]
「精霊なんて言うのは他国では神格に比肩するほどの概念で、守りは鉄壁に近い」[lrcm]
...
#【ユラギ】
「……ああそうだ。[chara_mod name="yuragi" face="emi_m" time="0"]でもこれは、私のために作られたものじゃないんだけどな」[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
...
#【ユラギ】
「昔、昔な。ハジメのように私と喋れる二人組の少年少女がいたんだ」[lrcm]
「名前は”彩”と”九郎”。私が初めて会話した人間で……そして、一番の親友たちだった」[lrcm]
...
[chara_mod name="yuragi" face="def" time="0"]
#【ユラギ】
「昔は今の事件の原因となっている歪みっていうのがもう少しひどくてな」[lrcm]
...
そしてこの少女の体をした彼女は……ずっと昔から何もできずにその苦しみを抱えて生きてきた。[lrcm]
それはきっと……想像できないほど耐え難いほどに辛い記憶だろう。[lrcm]
...
#
ぶんぶんと手を回し、テーブルに置いてある空灯に手をかざす。[lrcm]
...
#
よくわからなくなったのかユラギは空灯をバラし始める。[lrcm]
空灯の表面の紙が丁寧に剥がされ、中身があらわになる。[lrcm]
何本もの針金が複雑に絡み合った内部は、通常のスカイランタンとは比べ物にならないほど複雑な型だ。[lrcm]
