...
if (!(document.getElementById("title_base") != null || document.getElementsByClassName('layer_menu')[0].hasChildNodes())) {
  ...
  div1.setAttribute('style', 'position: relative;padding-top: 66px;');
  ...
  div2.setAttribute('style', 'position: relative;margin-top: 67px;');
  ...
  div4.setAttribute('style', 'position: relative;margin-top: 67px;');
  ...
  div5.setAttribute('style', 'position: relative;margin-top: 67px;');
