...
div1.setAttribute('style', 'position: relative;padding:48px 0;');
a1.setAttribute('href', "javascript:void(0);");
a1.setAttribute('onclick', 'document.getElementById("title_base").remove();tyrano.plugin.kag.ftag.startTag("jump", {storage: "plolog.ks",target: "*plolog"});');
mimg1.setAttribute('src', 'data/image/mstart.svg');
simg1.setAttribute('src', 'data/image/sstart.svg');
mimg1.setAttribute('style', 'margin: 0 auto;width:100%;-webkit-filter: drop-shadow(0 0 7px #fff);');
simg1.setAttribute('style', 'margin: 0 auto;position: absolute;top: 87px;left: 28px;-webkit-filter: drop-shadow(0 0 7px #fff);width: 57px;');
...
div2.setAttribute('style', 'position: relative;padding:48px 0;');
a2.setAttribute('href', "javascript:void(0);");
a2.setAttribute('onclick', 'document.getElementById("title_base").remove();TYRANO.kag.layer.getMenuLayer().empty();TYRANO.kag.layer.getMenuLayer().css("background-image","url(./data/image/save_bg.png)");TYRANO.kag.menu.displayLoad();');
mimg2.setAttribute('src', 'data/image/mload.svg');
simg2.setAttribute('src', 'data/image/sload.svg');
mimg2.setAttribute('style', 'margin: 0 auto;width:100%;-webkit-filter: drop-shadow(0 0 7px #fff);');
simg2.setAttribute('style', 'margin: 0 auto;position: absolute;top: 87px;left: 28px;-webkit-filter: drop-shadow(0 0 7px #fff);width: 57px;');
...
div3.setAttribute('style', 'position: relative;padding:48px 0;');
...
mimg3.setAttribute('style', 'margin: 0 auto;width:100%;-webkit-filter: drop-shadow(0 0 7px #fff);');
simg3.setAttribute('style', 'margin: 0 auto;position: absolute;top: 87px;left: 28px;-webkit-filter: drop-shadow(0 0 7px #fff);width: 57px;');
...
div4.setAttribute('style', 'position: relative;padding:48px 0;');
...
mimg4.setAttribute('style', 'margin: 0 auto;width:100%;-webkit-filter: drop-shadow(0 0 7px #fff);');
simg4.setAttribute('style', 'margin: 0 auto;position: absolute;top: 87px;left: 28px;-webkit-filter: drop-shadow(0 0 7px #fff);width: 57px;');
...
div5.setAttribute('style', 'position: relative;padding:48px 0;');
...
mimg5.setAttribute('style', 'margin: 0 auto;width:100%;-webkit-filter: drop-shadow(0 0 7px #fff);');
simg5.setAttribute('style', 'margin: 0 auto;position: absolute;top: 87px;left: 28px;-webkit-filter: drop-shadow(0 0 7px #fff);width: 57px;');
