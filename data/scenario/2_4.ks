...
分かってはいたつもりだが、言葉にされると重みを増す。[lrcm]
……そう、あれが今俺ができる精一杯だったのだ。[lrcm]
...
[chara_mod name="yuragi" face="def" time="0"]
#【ユラギ】
「他の日本神群は味方にできない……一応私が直接力を使う手段はあるが……」[lrcm]
...
#
森の奥。[lrcm]
ユラギの神域からさらに山の奥へ足を進めた場所。[lrcm]
しん、と静まり返る領域はユラギの神域と異なり、むせ返るような緑があたりを満たしている。[lrcm]
だが、そこは森の入り口付近の人を拒むような気配ではない。[lrcm]
それは、どこか綺麗に整理された〝住処〟のようだ。[lrcm]
...
#
そんな横文字をファンタジー世界に持ち込まないでほしい。[lrcm]
...
[manpu layer=0 name=yuragi type=oya x="50" y="100" width="80"]
#【ユラギ】
「うん。エネルギーの自由化来たし我々も人界に進出するか！　っていいって思金に全力で止められてた」[lrcm]
#
流石、天つ神の最終兵器。[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
#【ユラギ】
「まあ、名前こそ神ではないが、精霊は意思を持った〝自然〟だ。ある意味この国の神には持っていない強みがある」[lrcm]
「戦う事はできなくとも、彼らの力を借りれば、逃げることはできるだろう。この森全域に精霊は住み着いているから、森の中ならどこでも助けを呼べる」[lrcm]
#
この国の神としてはなんとも歯がゆい思いだが、と小声でユラギは言う。[lrcm]
[chara_mod name="yuragi" face="emi_m" time="0"]
#【ユラギ】
「とにかく話しかけてやってくれ……彼女たちもその……私と同じなのさ」[lrcm]
...
#
精霊が手のひらをペチペチと両手で叩く。[lrcm]
弱いが確かに触れている感覚を感じる。これはふつうの幽霊などが持つ力とは比べ物にならないほどの霊気をまとっていることの証拠だ。[lrcm]
……まあ、霊気なのかは怪しいが。[lrcm]
...
#
と、なんかよくわからない鳴き声をしながらユラギもついてくる。[lrcm]
...
#【？？？】
「わぁー、ひ、でるのー？　すごいすごい！　もり、もえない？　もえない？」[lrcm]

#【妖精】
『──！』[lrcm]

#
それは、色鮮やかな光に包まれた空間だった。[lrcm]
水や炎、稲妻や風。それらが小型のテーマパークのように色とりどりに木々の間を行き来し、中で小さな少女が踊っていた。[lrcm]
...
#
少女はこちらの後ろでぼーっと会話を聞いていたユラギの方を向いた。[lrcm]
...
#
おつきは。ふよふよと浮いているユラギと、手をつないでぐるぐると回り始める。[lrcm]
なんとも微笑ましい。[lrcm]
...
#
街での神隠し話題はまだ対岸の火事状態。[lrcm]
特に外出禁止令も出ていないので、子どもたちは普通に遊んでいる。[lrcm]
だが、先日の獣のことを考えると、この山に近づいているのは非常に危険だ。[lrcm]
...
#
こちらの驚愕する顔をどう受け取ったのか、おつきはなぜか焦りだし。[lrcm]

#【おつき】
「でもねでもね、おかーさんとおとーさんはおつきのためにとおくにいるから、それもがまんできる！　だいじょうぶ！」[lrcm]
[manpu layer=0 name=yuragi type=gaan x="20" y="80" width="80"]
#【ユラギ】
「くっ……ぐああああーーっそんなっ……そんなことがっ……」[lrcm]
...
そして、ヒソヒソとより集まりうなずきあう。[lrcm]
その表情はどこかワクワクがとまらないというようなふうだった。[lrcm]
