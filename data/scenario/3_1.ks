...
#
ユラギは、どこか震えるような声で言った。[lrcm]
それはなにかに怯えているようにも、泣いているようにも聞こえた[lrcm]
...
そこには、いくつもの大きな本棚と本が乱雑に開かれたままの机。[lrcm]
...
#
先程からユラギは黙ったままだ。[lrcm]
中に入り、机の上に乱雑に並べられている本を手にとって見る。[lrcm]
埃のかぶった背表紙を払うと、そこには『黒の一角獣についての報告書』と書かれている。[lrcm]
...
#
ユラギは、こちらの手を撮って立ち上がり、こちらの本を手に取る。[lrcm]
...
#
その後ろには怪物の時代ごとの特徴やその被害件数などが続いている。[lrcm]
その後の資料を流し読みしながら、思考する。[lrcm]

#【一】
「『人喰いの獣』か。でも……それじゃあなんで、攫われた人達はまだ生きているんだ……？」[lrcm]

#
ユラギの話によれば、さらわれた人々はまだ死んではいないという。[lrcm]
だが、さらに思い返してみれば変だ。人喰いの獣であれば、何故その場で人間を喰らわない……？[lrcm]
資料に書かれている獣に関しては無差別に人を喰らい続け、あたりに生物がいなくなるまで喰らうのをやめない。といった記述が多い。[lrcm]
...
#
頭をブンブンとふり、思い浮かべようとした情景をかき消す。[lrcm]
...
[chara_show name="yuragi" top="50" face="fukigen" time="0" top="150"]
#【ユラギ】
「私は……この獣……ううん、”この子”のことを知っていた……」[lrcm]
「この島で私の探知に干渉できる存在がこの子以外にいないことを知っていた……」[lrcm]
