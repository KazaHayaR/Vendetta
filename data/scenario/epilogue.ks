...
#【ユラギ】
「まぁ、この祭りが一番大きいから利用しているだけだけどなー」[lrcm]
[chara_mod name="yuragi" face="emi_m" time="0"]
「空灯が上がっているのも丁度いい。作り方も二人が作ったのに似ているから、祓具として使いやすいんだ」[lrcm]

#
ずずずっと、ユラギ焼きそばを思いっきり頬張りながら口を動かす。[lrcm]
本来この祭りは大量の誘拐事件などでほとんど中止の運びとなっていたが……」[lrcm]
ユラギと便利な神郡たちによる秘密工作(記憶改ざん)等の手段で強引に開かれることになった。[lrcm]
...
ちなみにこの処理はユラギやその他神々の手配に寄るものだ。[lrcm]
”人喰いの魔物”という数百年に及ぶ難題の解決がなされたということで、神々の制約が一時的に解かれたらしい。[lrcm]
そして、どこか遠方の神が来て、この島の人間から獣に関する一連の記憶が消去してくれた。[lrcm]
...
[chara_mod name="yuragi" face="emi_m" time="0"]
#【一】
「……ああ、そうだろう。だって、彩とクロウが二人で作り……二人が助けた星山が伝えた灯りだ」[lrcm]
[chara_mod name="yuragi" face="emi" time="0"]
「綺麗じゃないわけがない……輝かないはずがない」[lrcm]
#
...
[chara_mod name="yuragi" face="def" time="0"]
「神への信仰は薄れ、正月か、祭り日にたまに感じる程のものになった……」[lrcm]
[chara_mod name="yuragi" face="emi_m" time="0"]
「でもあの灯りは、もっと多くの人間に見られ、愛されている」[lrcm]
[chara_mod name="yuragi" face="terewara" time="0"]
...
[chara_mod name="yuragi" face="emi" time="0"]
#【ユラギ】
「ほぼ確じゃないかっ！　うんうん、いいだろう、そしたらいい感じの年齢の時に止めような！」[lrcm]
[manpu layer=0 name=yuragi type=heart3 x="50" y="100" width="80"]
「でも性欲的には今がベストかも知れないぞ！」[lrcm]
[quake count=5 time=100]
#【一】
「いやそれはどういう意味でベストなんですかね！？」[lrcm]
[chara_mod name="yuragi" face="def" time="0"]
#【ユラギ】
「あ、でもやっぱり、ロリコンというのは身体年齢が離れれば離れるほど興奮するものなのか……？」[lrcm]
...
[chara_mod name="yuragi" face="emi" time="0"]
#【ユラギ】
「なんだっまったく……！　今日という日は、こんなに君たちから贈り物をもらってしまって……！」[lrcm]
