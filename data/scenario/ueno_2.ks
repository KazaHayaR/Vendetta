...
#【？】
もしかしたら私にはとっくに分かっていたのかもしれない。母が命を賭して、私の命を繋いでくれていたこと。『還ノ島に伝わる獣の伝説』『それはこの世界のものではない。この世とあの世の境目が曖昧になった時現れる』『それは欲望に反応する。果てなき欲を抱き続ける人間という種にとってはまさしく天敵といえる存在である』『それは食欲に突き動かされ、あらゆるものを喰らう。生存のためではなく欲望を満たすための捕食である』『それは○▲◆×■という名を持つ』「還ノ島伝説（晴明社文庫）より抜粋」坂本家[lrcm]
#【坂本宗介】
「む…ううん…」[lrcm]
#【夕陽椿】
「あっ、起きた？」[lrcm]
...
#【坂本宗介】
ゆらぎは時々こういう電波チックなことを言うが、コイツのこういう勘は昔から大体当たってしまうから恐ろしい。俺が中学生の時事故（幸いかすり傷程度で済むようなものだったが）に遭った時も、その前ゆらぎに散々外出を止められてたっけ。[lrcm]
#【坂本宗介】
...
「…そうだな」[lrcm]
#【坂本宗介】
そう。俺たちがこんなことを考えたところで意味はない。こういうのは警察か猟友会の領分だ。俺たちは微妙な雰囲気のまま朝食を済ませると、各々学校へ向かった。学校[lrcm]
#【夕陽椿】
...
#【坂本宗介】
下らない話とは主に、お互いの女性の趣味・お互いの好きな女性の部位・お互いの女性に言わせてみたい台詞は何か・などなど多岐に渡る。下らないので俺はそんなに乗り気ではないのだが、桂はお構いなしに俺の性癖を掘り下げにかかってくるのだから厄介だ。[lrcm]
#【桂慎太郎】
...
「はあ…」[lrcm]
#【坂本宗介】
俺にできることは、災害のごとき幼馴染たちの相手をしながら事件解決を祈ることだけらしい。ちくしょうめ。放課後[lrcm]
#【坂本宗介】
...
「きゃっ！」[lrcm]
#【坂本宗介】
突然の着信で、俺たちは現実に引き戻された。慌てて椿から距離をとる。…危なかった。いや、何が危なかったのかと問われると困るんだが。[lrcm]
#【坂本宗介】
「すまん、着信だ！」[lrcm]
#【夕陽椿】
「う、うん！気にしないで」[lrcm]
#【坂本宗介】
「ああ、ちょっと失礼。…っと、父さんからだ。なるほどな」[lrcm]
#【夕陽椿】
「宗介パパ、なんだって？」[lrcm]
#【坂本宗介】
...
#【夕陽翔】
あるいは、科学捜査なんて及びもつかない存在がこの島に潜んでいるのか。
